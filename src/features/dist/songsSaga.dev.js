    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 6:
          ...
          _context2.next = 9;
          return (0, _effects.put)((0, _songsState.addSong)(newSong));
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          _context3.next = 10;
          return (0, _effects.put)((0, _songsState.updateSong)(updatedSongData));
  ...
  return regeneratorRuntime.wrap(function deleteSongAsync$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 3:
          _context4.next = 5;
          return (0, _effects.put)((0, _songsState.deleteSong)(action.id));
  ...
  return regeneratorRuntime.wrap(function songsSaga$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return (0, _effects.takeEvery)(_songsState.getSongsFetch.type, workGetSongsFetch);
